...
@WebServiceClient(name = "HelloService",
        ...
        wsdlLocation = "http://localhost:1234/hello?wsdl")
public class HelloService extends Service {
    ...
    private final static QName HELLOSERVICE_QNAME =
            new QName("http://ws.xml.jf.courses.epam.com/",
                    "HelloService");
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1234/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return getPort(new QName("http://ws.xml.jf.courses.epam.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return getPort(new QName("http://ws.xml.jf.courses.epam.com/", "HelloPort"),
                Hello.class, features);
    }
